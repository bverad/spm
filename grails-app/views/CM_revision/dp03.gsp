...
<g:javascript src="CM/revision_dp03.js" />
<g:form name="dp03" class="pure-form pure-form-stacked" >
	...
	<div class="pure-g-r">
		<isl:button action="postDp03" value="Siguiente"/>
	</div>
</g:form>
				...
				<div>
					<div id="modal-content" style="margin: 0 5px 0 5px;">
						...
						<div id="modal-clickers" style="letter-spacing: 0em; margin: 0 5px 0 5px;">
							<p>Se sugiere:</p>
							<input type="radio" id="modal-content-clickers-aprobar" name="modal-content-clickers" class="modal-content-clickers" value="Aprobar" checked="checked" /> Aprobar
							<input type="radio" id="modal-content-clickers-rechazar" name="modal-content-clickers" class="modal-content-clickers" value="Rechazar" /> Rechazar
							<input type="radio" id="modal-content-clickers-modificar" name="modal-content-clickers" class="modal-content-clickers" value="Modificar" /> Modificar Valor Unitario
						</div>

						<div id="modal-content-modifica-monto" style="margin: 0 5px 0 2px; width: 55%; float: left; border-color: #BBBBBB; border-width: 1px; border-style: solid; padding: 2px 2px 2px 2px;">
							...
							<input type="text" size="3" maxlength="7" id="modal-content-valor-unitario" name="modal-content-valor-unitario" style="margin-left: 5px; float: right;" />
						...
						<div id="modal-content-comment-wrapper" style="margin: 0 2px 0 5px; width: 40%; float: left;">
							<label style=": 0 10px 0 10px';">Comentarios:</label>
							<textarea id="modal-content-respuesta-texto" style="resize: none; height: 100%; width: 100%;"></textarea>
						</div>
					</div>
				</div>
			</fieldset>
