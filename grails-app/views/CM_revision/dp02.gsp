...
<g:javascript src="CM/revision_dp02.js" />
				...
				<div>
					<div id="modal-content" style="margin: 0 5px 0 5px;">
						...
						<div id="modal-clickers" style="letter-spacing: 0em; margin: 0 5px 0 5px;">
							...
							<input type="radio" id="modal-content-clickers-modificar" name="modal-content-clickers" class="modal-content-clickers" value="Modificar" /> Modificar Cantidad
							<input type="text"  id="modal-content-modificar-monto" name="modal-content-modificar-monto" class="modal-content-clickers" value="" size="5" maxlength="5" style="display: inline;" />
						</div>
