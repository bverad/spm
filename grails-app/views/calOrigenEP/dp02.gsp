...
<g:form name="dp02" class="pure-form pure-form-stacked" >
    ...
    <fieldset>
        ...
        <div class="pure-g-r">
            <div class="pure-u-1">
                ...
                <isl:textInput  cols="4-8" requerido="true" deshabilitado="true" nombre="tipo_siniestro" rotulo="Tipo Siniestro" valor="${siniestro.esEnfermedadProfesional ? 'Enfermedad Profesional' : 'Trabajo'}"/>
    ...
    <div class="pure-g-r">
    	<g:actionSubmit id="posponer_complejidad" value="Posponer"  action="cu02p" class="pure-button pure-button-warning" formnovalidate="formnovalidate" />
        <g:actionSubmit value="Asignar Complejidad"  action="cu02a" class="pure-button pure-button-success"  />
    </div>
</g:form>